...
const Aboutweb = () => {
  return (
    <div>
        ...
        <div className=' text-2xl font-semibold font-lead leading-10 m-6'>
            ...
            such as: admin dashboard where over 90% of data on the page are being controlled and manipulated, you can navigate to '/admin-signin' to see the login, users ip scrapper(using 
